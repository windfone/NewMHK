...
import com.hlxyedu.mhk.ui.exercise.presenter.ListeningPresenter;
...
//        @Override
//        public void time(int proccess) {
//            String name =filePath.substring(filePath.length()-6,filePath.length());
//            if(!name.equals("Di.mp3")) {
//                BaseEvents baseEvents = new BaseEvents(EventsConfig.SHOW_AUDIO_VIEW);
//                baseEvents.setData(proccess/1000);
//                EventBus.getDefault().post(baseEvents);
//            }
//
//        }
    };
...
//            LogUtil.debug(TAG,"setUserVisibleHint","true");
            // prepareAudio();
            //开始执行
            startTraining();
        } else {
            //onInvisible();
//            LogUtil.debug(TAG, "setUserVisibleHint", "false");
            stopPlaying();
        }
    }
    ...
    public void commitSuccess(ScoreVO scoreVO) {
        RxBus.getDefault().post(new UIEvent(UIEvent.UI_CONTROL,true));
...
//                Button compete_btn=getView(view, R.id.compete_btn);
//                compete_btn.setOnClickListener(new View.OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
//                        EventBus.getDefault().post(new BaseEvents(EventsConfig.KILL_ACTIVITY,"end"));
//                    }
//                });
                break;
        }
