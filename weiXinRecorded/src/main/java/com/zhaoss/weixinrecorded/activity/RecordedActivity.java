 ...
 * https://blog.csdn.net/lianchen/article/details/43741335 Service 中调用相机
 */
public class RecordedActivity extends BaseActivity {
    ...
    public static final float MAX_VIDEO_TIME = 100000f*1000;  //最大录制时间
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LanSongFileUtil.setFileDir("/sdcard/AAAAAAA/"+System.currentTimeMillis()+"/");
